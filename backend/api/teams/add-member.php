...
if ($method === 'POST') {
    try {
        ...
        if ($result['count'] > 0) {
            sendError('User is already a member of this team', 400);
        }
        ...
        sendSuccess(['message' => 'Member added successfully'], 'Member added successfully');
    } catch (PDOException $e) {
        sendError('Failed to add member: ' . $e->getMessage(), 500);
    }
} else {
